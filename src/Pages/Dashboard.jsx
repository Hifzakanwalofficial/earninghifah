...
const Dashboard = () => {
  ...
  const ShimmerCard = () => (
    <div className="w-1/2 bg-[#f8f9fb] px-[14px] py-[22px] rounded-[8px] animate-pulse">
  ...
  if (loading) {
    return (
      <div className="p-6">
        <div className="flex justify-between items-center pt-[31px] pb-[20px]">
          <div className="h-[28px] bg-gray-200 rounded w-[160px] animate-pulse"></div>
          <div className="h-[50px] w-[104px] bg-gray-300 rounded animate-pulse"></div>
        </div>
  ...
  return (
    <div className='p-6'>
      ...
      <div className="flex gap-4 mb-[32px]">
        <div
          className="w-1/2 bg-[#0078BD] px-[14px] py-[12px] rounded-[8px]"
          style={{ boxShadow: '0px 0px 16px #E3EBFC' }}
        >
          <div className="flex items-center justify-between mt-2 px-[14px] py-[20px]">
            <p className="text-[hsl(0,0%,100%)] text-[30px] robotomedium">Today’s Earnings</p>
            <p className="text-[#ffffff] robotobold text-[32px]">
        ...
        {/* LEFT CARD */}
        <div
          className="w-1/2 bg-[#ffffff] px-[14px] py-[10px] rounded-[8px] flex items-center justify-between"
          style={{ boxShadow: '0px 0px 16px #E3EBFC' }}
        >
          <div>
            <p className="text-[#0078BD] robotomedium text-[30px]">Total Earnings</p>
          </div>
          <div className="robotobold text-[black] text-[32px]">
