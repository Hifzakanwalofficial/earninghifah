...
const Overview = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 sm:p-6">
      {/* Topbar */}
      <div>
        <p className='robotosemibold text-[24px]  mb-[20px] sm:mb-[44px]'>Dashboard Overview</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6">
        <div className="bg-white px-[14px] py-[24px] rounded-xl shadow hover:shadow-lg transition flex items-center justify-between">
          <div>
            <h2 className=" text-[12px] sm:text-[16px] robotomedium text-[#333333B2]">Total CALLS</h2>
            <p className=" text-[18px] sm:text-2xl font-bold mt-2">{stats.totalCalls}</p>
          </div>
        ...
        <div className="bg-white px-[14px] py-[24px] rounded-xl shadow hover:shadow-lg transition flex items-center justify-between">
          <div>
            <h2 className="text-[12px] sm:text-[16px] robotomedium text-[#333333B2]">Total REMS</h2>
            <p className=" text-[18px] sm:text-2xl font-bold mt-2">{stats.totalRems.toLocaleString()}</p>
          </div>
          <div className='bg-[#778da93f] h-[40px] w-[40px] rounded-full flex items-center justify-center'>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="bg-white px-[14px] py-[24px] rounded-xl shadow hover:shadow-lg transition flex items-center justify-between">
          <div>
            <h2 className="text-[12px] sm:text-[16px] robotomedium text-[#333333B2]">Total RPM</h2>
            <p className="text-[18px] sm:text-2xl font-bold mt-2">{stats.totalRpm.toLocaleString()}</p>
          </div>
          <div className='bg-[#778da93f] h-[40px] w-[40px] rounded-full flex items-center justify-center'>
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M16.1445 10.7148C15.4531 11.1914 14.8867 11.6055 14.8828 11.6367C14.8828 11.6641 14.9258 11.8086 14.9766 11.9492C15.1094 12.3203 15.2734 13.0703 15.3008 13.4492C15.3125 13.625 15.3398 13.8086 15.3555 13.8555L15.3906 13.9453H16.8516C18.1094 13.9453 18.3164 13.9375 18.3594 13.8867C18.4687 13.7578 18.3281 12.3867 18.125 11.5898C17.9648 10.957 17.5234 9.84375 17.4297 9.84375C17.4141 9.84375 16.8359 10.2344 16.1445 10.7148Z" fill="#0078BD"/>
        ...
        <div className="bg-white px-[14px] py-[24px] rounded-xl shadow hover:shadow-lg transition flex items-center justify-between">
          <div>
            <h2 className=" text-[12px] sm:text-[16px] robotomedium text-[#333333B2]">Total PR1</h2>
            <p className=" text-[18px] sm:text-2xl font-bold mt-2">{stats.totalPri.toLocaleString()}</p>
          </div>
          <div className='bg-[#778da93f] h-[40px] w-[40px] rounded-full flex items-center justify-center'>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="20" height="20" fill="white"/>
  ...
  <div className="bg-white px-[14px] py-[24px] rounded-xl shadow hover:shadow-lg transition flex items-center justify-between 
                  col-span-2 lg:col-span-1">          <div>
            <h2 className=" text-[12px] sm:text-[16px] robotomedium text-[#333333B2]">Total Earning</h2>
            <p className="text-[18px] sm:text-2xl font-bold mt-2">${stats.grandTotal.toLocaleString()}</p>
          </div>
          <div className='bg-[#778da93f] h-[40px] w-[40px] rounded-full flex items-center justify-center'>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div className='mt-6'>
      ...
      <div className='mt-[44px]'>
        <p className="robotomedium  text-[16px] sm:text-[20px]">Monthly Performances</p>
        <p className="robotoregular text-[12px] sm:text-[16px]  text-[#707070]">Overview of calls, Pr1, Rems, and Rpm over the last  month.</p>
      </div>
